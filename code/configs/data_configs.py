...
DATASETS = {
    ...
    'lrs2': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['lrs2'],
		'train_target_root': dataset_paths['lrs2'],
		'test_source_root': dataset_paths['lrs2'],
		'test_target_root': dataset_paths['lrs2'],
	},
    'lrs2_cmlr': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['lrs2_cmlr'],
		'train_target_root': dataset_paths['lrs2_cmlr'],
		'test_source_root': dataset_paths['lrs2_cmlr'],
		'test_target_root': dataset_paths['lrs2_cmlr'],
	},
}
