...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir',default='/home/wls/wxb/logs', type=str, help='Path to experiment output directory')
		self.parser.add_argument('--dataset_type', default='lrs2_cmlr', type=str, help='Type of dataset/experiment to run')
		...
		self.parser.add_argument('--train_decoder', default=True, type=bool, help='Whether to train the decoder model')
		...
		self.parser.add_argument('--psnr', default=1, type=float, help='psnr')
		self.parser.add_argument('--fid', default=1, type=float, help='fid')
		self.parser.add_argument('--lse-d', default=1, type=float, help='lse-d')
		self.parser.add_argument('--lse-c', default=1, type=float, help='lse-c')



		#mouth
		self.parser.add_argument('--lipsyn', default=0, type=float,help='loss of lip')

		self.parser.add_argument('--stylegan_weights', default=model_paths['stylegan_ffhq'], type=str, help='Path to StyleGAN model weights')
		self.parser.add_argument('--checkpoint_path', default='/home/wls/wxb/2024.6.27/pixel2style2pixel-master/pertrained_models/psp_ffhq_encode.pt', type=str, help='Path to pSp model checkpoint')
		#self.parser.add_argument('--checkpoint_path', default=None, type=str, help='Path to pSp model checkpoint')

		self.parser.add_argument('--max_steps', default=500000000000000, type=int, help='Maximum number of training steps')
		self.parser.add_argument('--image_interval', default=1000, type=int, help='Interval for logging train images during training')
		self.parser.add_argument('--board_interval', default=200, type=int, help='Interval for logging metrics to tensorboard')
		self.parser.add_argument('--val_interval', default=3000, type=int, help='Validation interval')
		...
		self.parser.add_argument('--syncnet_checkpoint_path', default='pertrained_models\lipsync_expert.pth',help='Load the pre-trained Expert discriminator', required=False, type=str)
	def parse(self):
